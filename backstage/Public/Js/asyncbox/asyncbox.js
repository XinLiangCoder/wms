...
(function(a) {
	...
	function C(a, b, c, d) {
		...
		case "confirm":
			...
			break;
		case "audit" :
			f.buttons = D.btn.PASSREJECTCANCEL;
			f.icon = G + 'confirm';
			break;
		case "warning":
	...
	D.btn = {
		...
		PASS: [{
			value: D.Language.PASS,
			result: "pass"
		}],
		REJECT: [{
			value: D.Language.REJECT,
			result: "reject"
		}]
	},
	...
	D.btn.PASSREJECTCANCEL = D.btn.PASS.concat(D.btn.REJECT).concat(D.btn.CANCEL),
